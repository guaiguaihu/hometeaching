package com.sida.controller;

import com.sida.entity.RestResult;
import com.sida.entity.SysUser;
import com.sida.service.SysUserService;
import com.sida.utils.ResultGenerator;
...
public class MainController {
    ...
    @Autowired  //自动装配
    public MainController(SysUserService userService, ResultGenerator generator) {
    ...
    public RestResult teacherRegister(@Valid SysUser user, BindingResult bindingResult) {
    ...
    public RestResult studentRegister(@Valid SysUser user, BindingResult bindingResult) {
        return generator.getSuccessResult("用户注册成功",userService.saveUser(user));
    }
    ...
    public RestResult updateTeacher(@Valid SysUser user, BindingResult bindingResult) {
        return generator.getSuccessResult("用户注册成功",userService.saveUser(user));
    }
    ...
    public RestResult updateStudent(@Valid SysUser user, BindingResult bindingResult) {
        return generator.getSuccessResult("用户注册成功",userService.saveUser(user));
    }
